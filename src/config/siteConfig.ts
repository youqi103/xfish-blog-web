...
export const siteConfig: SiteConfig = {
	title: "XFishBlog",
	subtitle: "Demo site",
	site_url: "https://xfishblog.vercel.app",
	description:
		"XFishBlog是一个基于Firefly模板开发的的个人博客网站。",
	keywords: [
		"XFishBlog",
		"Fuwari",
		"Astro",
	...
	navbarTitle: "XFishBlog", // 导航栏标题，可以设置为与 title 不同的值，如果不设置则使用 title
	...
	backgroundWallpaper: {
		...
		banner: {
			...
			homeText: {
				...
				enable: true,
				// 主页横幅主标题
				title: "Welcome to Xiaoyu's Blog!",
				// 主页横幅副标题
				subtitle: [
